export const PERSONALIZED_WELCOME_EMAIL_PROMPT = `Generate a warm, professional, and slightly enthusiastic HTML introduction for a welcome email.

User: {{name}}

PERSONALIZATION REQUIREMENTS:
You MUST create content that makes the user feel valued and excited to start their journey with Tikki Trades:
...
1. **Focus on Empowerment**: Reference how Tikki Trades helps regular people take control of their financial future through AI-driven insights and real-time data.

2. **Contextual Messaging**: 
   - Mention that they now have access to institutional-grade tools.
   - Reference the **Stock Pulse** feature for catching market sentiment.
   - Reference **Sentinel Score** for AI-powered decision making.

3. **Tone**: Modern, premium, and institutional but accessible.
...
- Use <strong> for key feature names (Stock Pulse, Sentinel Score, etc.)
- DO NOT include "Here's what you can do right now:" as this is already in the template
- Second sentence should add helpful context or reinforce the value proposition.

Example personalized outputs:
<p class="mobile-text" style="margin: 0 0 30px 0; font-size: 16px; line-height: 1.6; color: #CCDADC;">Thanks for joining Tikki Trades! You've just unlocked institutional-grade tools like <strong>Stock Pulse</strong> and <strong>Sentinel Score</strong> to help you navigate the markets with confidence. We're excited to help you take full control of your financial journey starting today.</p>`;
