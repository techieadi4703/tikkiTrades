...
export default function NewsSkeleton() {
  return (
    <div className="w-full flex flex-col gap-8 h-[600px] xl:h-[842px]">
      {/* Score Skeleton */}
      <div className="bg-secondary/50 backdrop-blur-xl border border-border rounded-2xl p-6 shadow-2xl flex flex-col items-center animate-pulse shrink-0">
        ...
        <div className="relative flex items-center justify-center w-40 h-40 mb-4">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <div className="h-10 w-16 bg-secondary/50 rounded mb-2"></div>
            <div className="h-3 w-10 bg-secondary/50 rounded"></div>
          </div>
        </div>
        
        <div className="h-6 w-32 bg-secondary/50 rounded mb-6"></div>
        
        <div className="w-full p-4 bg-secondary/50 rounded-xl flex items-center justify-center gap-3">
      ...
      <div className="w-full flex-1 flex flex-col min-h-[150px] animate-pulse overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto pr-3 scrollbar-hide">
          <div className="flex flex-col gap-4 pb-4">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div key={i} className="bg-secondary/50 border border-border rounded-2xl p-5 shrink-0">
                <div className="flex justify-between items-start gap-4 mb-3">
                  ...
                  <div className="shrink-0 w-24 h-24 rounded-lg bg-secondary/50 hidden sm:block"></div>
                </div>
